...
const Navbar=({mode,setMode})=>{
  ...
  const handleSearch = () => {
    switch (searchTerm.toLowerCase()) {
      ...
      default:
        ...
        console.log('Search term not found:', searchTerm);
        break;
    }
  };
  ...
  return (
    ...
    <Box sx={{ flexGrow: 1 }} bgcolor='#f1f1f1' color={"text.primary"}>

      <AppBar position="fixed" elevation={0} sx={{backgroundColor:"#1976d2",color:"#000000"}} color="primary" enableColorOnDark>
        <Toolbar>
          <IconButton
            size="large"
            edge="start"
